...
var configure = {
    ...
    getLocations: function (callback) {
        configure.locationOptions = new OptionsModel({
        ...
        configure.locationOptions.LoadOptions();
    },
    ...
    applyLayout: function (selector, selectionCallback) {
        $(selector).first('.options-group').accordion({
            ...
            beforeActivate: function (event, ui) {
                ...
                //var optionName = configure.viewModel.Profile.Locations.Options()[itemindex].OptionName();
                var optionName = "FL";
                var cityOptions = new OptionsModel({
                    optionsUrl: 'http://localhost:15718/api/Location/StateProvinceCity?name=' + optionName,
                    nameProperty: 'CityName',
                    idProperty: 'Id',
                    parentCallback: function (result) {
                        configure.viewModel.Profile.Locations.Options()[itemindex].SubOptions(result.Options);
                        //callback();
                    }
                });
                cityOptions.LoadOptions();
            }
        })
    },
    layout: function () {
        ...
        configure.applyLayout('#locations', function (itemindex) {
